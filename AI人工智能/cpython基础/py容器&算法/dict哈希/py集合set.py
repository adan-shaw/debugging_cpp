...
isdisjoint()					返回两个'set集合'的交集是否为空集
...
'''
	...
	将两个'set集合'剩下所有非共有的元素,
	最后将这'两个'set集合'的非共有的元素', 写入到调用symmetric_difference_update() 的那个'set集合';
'''
pset1 = {"a", "b" , "c", 1, 2}
pset2 = {1, 2, 3}
