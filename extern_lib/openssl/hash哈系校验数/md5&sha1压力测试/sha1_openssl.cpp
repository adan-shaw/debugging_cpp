//编译:
//		g++ -g3 -lcrypto ./sha1_openssl.cpp -o x
...
int main(void){
	...
	SHA1((const unsigned char *)data,str_len,md5_result);	//测试1
	...
	SHA1((const unsigned char *)data2,str_len,md5_result);//测试2
	...
	SHA1((const unsigned char *)data3,str_len,md5_result);//测试3
