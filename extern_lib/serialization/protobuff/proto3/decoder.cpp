...
int main(void)
{
	...
	//google::protobuf::Map<std::string, v3proto::Message> _msg_map = msg_arr.msg_map();
	google::protobuf::Map<std::string, v3proto::Message>::const_iterator it = msg_arr.msg_map().begin();
