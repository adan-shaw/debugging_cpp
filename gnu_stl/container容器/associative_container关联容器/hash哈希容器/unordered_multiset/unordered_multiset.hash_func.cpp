//编译:
//		g++ -std=c++11 -g3 ./unordered_multiset.hash_func.cpp -w -o x 
...
int main(void){
	unordered_multiset<Customer, CustormerHash, CustormerKeyCmp> x1;
	unordered_multiset<Customer, CustormerHash, CustormerKeyCmp>::iterator it;
	//unordered_multiset<Customer, hash_func, key_func> x2;							//失败
	//unordered_multiset<Customer, hash_func, key_func>::iterator it2;	//失败
	Customer m("陈0");
